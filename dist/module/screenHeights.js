...
export var sfvcScreens = {
  ...
  "932": {
    ...
    // 732 removed as same in Safari
    textSizeHeightsNoTabs: [854, 852, 850, 848],
    zoomHeight: {
      "1.15": [746, 742, 738],
      // 733 removed as same in Safari
      "1.25": [746, 743],
      // 738, 733 removed as same in Safari
      "1.5": [746, 743],
      // 738, 732 removed as same in Safari
      "1.75": [746, 742, 739],
      // 732 removed as same in Safari
      "2": [746, 742],
      // 738, 732 removed as same in Safari
      ...
      // 738, 733 removed as same in Safari
      "3": [749],
      // 743, 740, 734 removed as same in Safari
  ...
  "852": {
    ...
    // 652 removed as same in Safari
    textSizeHeightsNoTabs: [774, 772, 770, 768],
    zoomHeight: {
      "1.15": [666, 662, 658],
      // 652 removed as same in Safari
      "1.25": [665, 661, 658],
      // 651 removed as same in Safari
      "1.5": [666, 662, 659],
      // 653 removed as same in Safari
      "1.75": [667, 662],
      // 658, 653 removed as same in Safari
      "1.99": [663, 659],
      // 655, 649 removed as same in Safari
      "2": [663, 659],
      // 655, 649 removed as same in Safari
      "2.5": [665, 663],
      // 658, 653 removed as same in Safari
