    ...
    return function(modules) {
        ...
        "./src/decorators.js": function(module, __webpack_exports__, __webpack_require__) {
            ...
            __webpack_exports__.a = function(target, name, descriptor) {
                descriptor.value = Object(__WEBPACK_IMPORTED_MODULE_0__util__.H)(descriptor.value, {
                    name: name,
                    thisNamespace: !0
                });
            };
            __webpack_exports__.b = function(target, name, descriptor) {
                descriptor.value = Object(__WEBPACK_IMPORTED_MODULE_0__util__.Q)(descriptor.value, {
                    name: name
                });
            };
        ...
        "./src/dom.js": function(module, __webpack_exports__, __webpack_require__) {
            ...
            __webpack_exports__.Y = function waitForWindowReady() {
                return Object(util.x)(waitForWindowReady, function() {
            ...
            __webpack_exports__.J = function(element, handler) {
                element.addEventListener("touchstart", util.K);
            ...
            __webpack_exports__.w = function getScript(_ref) {
                ...
                return Object(util.x)(getScript, function() {
            ...
            __webpack_exports__.G = function isLocalStorageEnabled() {
                return Object(util.x)(isLocalStorageEnabled, function() {
                    try {
            ...
            __webpack_exports__.l = function(id) {
                return new src.a(function(resolve, reject) {
                    var name = Object(util._1)(id), el = getElementSafe(id);
            ...
            __webpack_exports__.M = function(url, options) {
                ...
                var params = Object.keys(options).map(function(key) {
                    if (options[key]) return key + "=" + Object(util._1)(options[key]);
            ...
            __webpack_exports__.Z = function(element, handler) {
                handler = Object(util.M)(handler);
                var interval = void 0;
                isElementClosed(element) ? handler() : interval = Object(util.X)(function() {
            ...
            function waitForDocumentReady() {
                return Object(util.x)(waitForDocumentReady, function() {
                    return new src.a(function(resolve) {
            ...
            function parseQuery(queryString) {
                return Object(util.x)(parseQuery, function() {
                    var params = {};
            ...
            function enablePerformance() {
                return Object(util.x)(enablePerformance, function() {
            ...
            function getElement(id) {
                ...
                throw new Error("Can not find element: " + Object(util._1)(id));
            }
            ...
            function createElement() {
                ...
                options.style && Object(util.q)(element.style, options.style);
            ...
            function setVendorCSS(element, name, value) {
                ...
                for (var capitalizedName = Object(util.f)(name), _i12 = 0, _length12 = null == VENDOR_PREFIXES ? 0 : VENDOR_PREFIXES.length; _i12 < _length12; _i12++) {
        ...
        "./src/experiment.js": function(module, __webpack_exports__, __webpack_require__) {
            ...
            __webpack_exports__.a = function(_ref) {
                var group, name = _ref.name, _ref$sample = _ref.sample, sample = void 0 === _ref$sample ? 50 : _ref$sample, _ref$logTreatment = _ref.logTreatment, logTreatment = void 0 === _ref$logTreatment ? __WEBPACK_IMPORTED_MODULE_0__util__.K : _ref$logTreatment, _ref$logCheckpoint = _ref.logCheckpoint, logCheckpoint = void 0 === _ref$logCheckpoint ? __WEBPACK_IMPORTED_MODULE_0__util__.K : _ref$logCheckpoint, throttle = function(name) {
        ...
        "./src/global.js": function(module, __webpack_exports__, __webpack_require__) {
            "use strict";
            __webpack_exports__.a = function(_ref) {
                var name = _ref.name, _ref$version = _ref.version, version = void 0 === _ref$version ? "latest" : _ref$version, global = Object(__WEBPACK_IMPORTED_MODULE_0__util__.s)(), globalKey = "__" + name + "__" + version + "_global__", namespace = global[globalKey] = global[globalKey] || {};
                return {
        ...
        "./src/index.js": function(module, __webpack_exports__, __webpack_require__) {
            ...
            __webpack_require__.d(__webpack_exports__, "weakMapMemoize", function() {
                return __WEBPACK_IMPORTED_MODULE_5__util__._9;
            });
            __webpack_require__.d(__webpack_exports__, "weakMapMemoizePromise", function() {
                return __WEBPACK_IMPORTED_MODULE_5__util__._10;
            });
        ...
        "./src/storage.js": function(module, __webpack_exports__, __webpack_require__) {
            ...
            __webpack_exports__.a = function getStorage(_ref) {
                ...
                return Object(__WEBPACK_IMPORTED_MODULE_0__util__.x)(getStorage, function() {
                    ...
                    function getState(handler) {
                        ...
                        storage || (storage = Object(__WEBPACK_IMPORTED_MODULE_0__util__.s)()[STORAGE_KEY]);
                        storage || (storage = {
                            id: Object(__WEBPACK_IMPORTED_MODULE_0__util__._7)()
                        });
                        storage.id || (storage.id = Object(__WEBPACK_IMPORTED_MODULE_0__util__._7)());
                        accessedStorage = storage;
                        var result = handler(storage);
                        localStorageEnabled ? window.localStorage.setItem(STORAGE_KEY, JSON.stringify(storage)) : Object(__WEBPACK_IMPORTED_MODULE_0__util__.s)()[STORAGE_KEY] = storage;
                    ...
                    function getSession(handler) {
                        return getState(function(storage) {
                            ...
                            session || (session = {
                                guid: Object(__WEBPACK_IMPORTED_MODULE_0__util__._7)(),
                                created: now
                            });
        ...
        "./src/test.js": function(module, __webpack_exports__, __webpack_require__) {
            ...
            __webpack_exports__.a = function(method) {
                var _ref$timeout = (arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}).timeout, expected = [], promises = [], timer = setTimeout(function() {
                    ...
                    var fn = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : __WEBPACK_IMPORTED_MODULE_1__util__.K;
                    expected.push(name);
                    return function() {
                        for (var _this = this, _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) args[_key] = arguments[_key];
                        Object(__WEBPACK_IMPORTED_MODULE_1__util__.V)(expected, name);
                        var _tryCatch = Object(__WEBPACK_IMPORTED_MODULE_1__util__._5)(function() {
                    ...
                    return function() {
                        ...
                        Object(__WEBPACK_IMPORTED_MODULE_1__util__.V)(expected, name);
                        var _tryCatch2 = Object(__WEBPACK_IMPORTED_MODULE_1__util__._5)(function() {
                        ...
                        }, __WEBPACK_IMPORTED_MODULE_1__util__.K));
                        return result;
                    };
                };
        ...
        "./src/util.js": function(module, __webpack_exports__, __webpack_require__) {
            ...
            __webpack_exports__.t = getObjectID;
            ...
            __webpack_exports__.x = function(method, logic) {
            ...
            __webpack_exports__.F = match;
            __webpack_exports__.b = function(obj, key) {
            ...
            __webpack_exports__._2 = function stringifyError(err) {
            ...
            __webpack_exports__.q = function(obj, source) {
                if (!source) return obj;
                if (Object.assign) return Object.assign(obj, source);
                for (var key in source) source.hasOwnProperty(key) && (obj[key] = source[key]);
                return obj;
            };
            __webpack_exports__._8 = function(obj) {
                var result = [];
            ...
            __webpack_exports__.T = function(str, regexp, handler) {
                var results = [];
            ...
            __webpack_exports__._4 = function(svg) {
            ...
            __webpack_exports__.U = function(text, regexp) {
                var result = [];
            ...
            __webpack_exports__.X = safeInterval;
            __webpack_exports__.A = isInteger;
            __webpack_exports__.z = isFloat;
            __webpack_exports__.Z = serializePrimitive;
            __webpack_exports__.m = deserializePrimitive;
            __webpack_exports__.o = function dotify(obj) {
            ...
            __webpack_exports__.j = function(string) {
                return string.replace(/-([a-z])/g, function(g) {
            ...
            __webpack_exports__.r = function(item, path, def) {
                if (!path) return def;
            ...
            __webpack_exports__.Y = function(method, time) {
            ...
            __webpack_exports__.l = defineLazyProp;
            __webpack_exports__.B = isObject;
            __webpack_exports__.C = isObjectObject;
            __webpack_exports__.D = isPlainObject;
            __webpack_exports__.W = function replaceObject(item, replacer) {
            ...
            __webpack_exports__.h = function(source, target, name, def) {
                if (source.hasOwnProperty(name)) {
                    var descriptor = Object.getOwnPropertyDescriptor(source, name);
                    Object.defineProperty(target, name, descriptor);
                } else target[name] = def;
            };
            __webpack_exports__.R = regex;
            __webpack_exports__.S = function(pattern, string) {
            ...
            __webpack_exports__.y = function(value) {
                return null !== value && void 0 !== value;
            };
            __webpack_exports__.i = function cycle(method) {
            ...
            __webpack_exports__.u = function(obj, key, getter) {
                if (obj.hasOwnProperty(key)) return obj[key];
                var val = getter();
                obj[key] = val;
                return val;
            };
            __webpack_exports__.g = function(obj) {
                var tasks = [], cleaned = !1;
                return {
            ...
            __webpack_exports__._5 = function(fn) {
            ...
            __webpack_exports__.V = function(arr, item) {
                var index = arr.indexOf(item);
                -1 !== index && arr.splice(index, 1);
            };
            __webpack_exports__.a = function(name, thing) {
