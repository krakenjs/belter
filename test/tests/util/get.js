...
describe('get cases', () => {
    ...
    it('getOrSet should get value when exists in object', () => {
        const result = getOrSet({ value: true }, 'value', () => true);
    ...
    it('getOrSet should set ad get value when not exists in object', () => {
        const result = getOrSet({ }, 'value', () => true);
