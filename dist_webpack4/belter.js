    ...
    function (module, __webpack_exports__, __webpack_require__) {
      ...
      function isSFVC(ua) {
        ...
        if (isIos(ua)) {
          ...
          var device = null;
          if (isIOS14(ua)) device = sfvcScreens[window.outerHeight];
          else {
            if (1 !== scale) return !0;
          ...
          return (
            !device ||
            (scale > 1 && device.zoomHeight && device.zoomHeight[scale]
              ? -1 !== device.zoomHeight[scale].indexOf(computedHeight)
              : -1 !== device.textSizeHeights.indexOf(computedHeight) ||
                -1 !== device.textSizeHeightsNoTabs.indexOf(computedHeight))
          );
        }
        return !1;
      }
      function isSFVCorSafari(ua) {
        ...
        if (isIos(ua)) {
          ...
          scale > 1 &&
            ...
            -1 !== possibleSafariSizes[scale].indexOf(computedHeight) &&
            (maybeSafari = !0);
      ...
      function isChrome(ua) {
        ...
        return (
          ...
          !/SamsungBrowser|Silk|EdgA/.test(ua)
        );
      }
      function isSafari(ua) {
        void 0 === ua && (ua = getUserAgent());
        return (
          /Safari/.test(ua) && !isChrome(ua) && !/Silk|FxiOS|EdgiOS/.test(ua)
        );
      }
      ...
      var promise_ZalgoPromise = (function () {
        ...
        ZalgoPromise.isPromise = function (value) {
          return (
            !!(value && value instanceof ZalgoPromise) || utils_isPromise(value)
          );
        };
      ...
      function getDomain(win) {
        ...
        return domain && win.mockDomain && 0 === win.mockDomain.indexOf("mock:")
          ? win.mockDomain
          : domain;
      }
      ...
      function uniqueID() {
        ...
        return (
          ...
          "_" +
          base64encode(new Date().toISOString().slice(11, 19).replace("T", "."))
            .replace(/[^a-zA-Z0-9]/g, "")
            .toLowerCase()
        );
      }
      ...
      function stringifyErrorMessage(err) {
        ...
        return err
          ? err instanceof Error
            ...
            : ("string" == typeof err.message && err.message) || defaultMessage
          : defaultMessage;
      }
      ...
      function promiseDebounce(method, delay) {
        ...
        return setFunctionName(function () {
          ...
          timeout = setTimeout(function () {
            promise = null;
            timeout = null;
            promise_ZalgoPromise.try(method).then(
              function (result) {
      ...
      function undotify(obj) {
        var result = {};
        for (var key in obj)
          if (obj.hasOwnProperty(key) && "string" == typeof obj[key]) {
            var value = obj[key];
            if (key.match(/^.+\[\]$/)) {
              key = key.slice(0, -2);
      ...
      function formatQuery(obj) {
        ...
        return Object.keys(obj)
          ...
          .map(function (key) {
            var val = obj[key];
            if ("string" != typeof val && "boolean" != typeof val)
      ...
      function getPageRenderTime() {
        return waitForDocumentReady().then(function () {
          ...
          if (performance) {
            ...
            return timing.connectEnd && timing.domInteractive
              ? timing.domInteractive - timing.connectEnd
              : void 0;
          }
        });
      }
        ...
        return inlineMemoize(
          ...
          function () {
            ...
            for (var _i4 = 0; _i4 < scripts.length; _i4++) {
              ...
              if (
                script.src &&
                script.src.replace(/^https?:\/\//, "").split("?")[0] === url
              )
                return script;
            }
          },
        ...
        return inlineMemoize(isLocalStorageEnabled, function () {
          try {
            ...
            if (window.localStorage) {
              ...
              var result = window.localStorage.getItem(
      ...
      function popup(url, options) {
        var _options$closeOnUnloa = (options = options || {}).closeOnUnload,
          closeOnUnload =
            void 0 === _options$closeOnUnloa ? 1 : _options$closeOnUnloa,
      ...
      function awaitFrameLoad(frame) {
        if (
          (awaitFrameLoadPromises =
            awaitFrameLoadPromises || new weakmap_CrossDomainSafeWeakMap()).has(
            frame
          )
        ) {
      ...
      function bindEvents(element, eventNames, handler) {
        ...
        for (var _i12 = 0; _i12 < eventNames.length; _i12++)
          element.addEventListener(eventNames[_i12], handler);
        return {
          cancel: once(function () {
            for (var _i14 = 0; _i14 < eventNames.length; _i14++)
              element.removeEventListener(eventNames[_i14], handler);
          }),
        };
      }
      ...
      function setVendorCSS(element, name, value) {
        ...
        for (var _i16 = 0; _i16 < VENDOR_PREFIXES.length; _i16++)
          element.style["" + VENDOR_PREFIXES[_i16] + capitalizedName] = value;
      }
      ...
      function animate(element, name, clean, timeout) {
        ...
        return new promise_ZalgoPromise(function (resolve, reject) {
          ...
          endEvent = bindEvents(el, ANIMATION_END_EVENTS, function (event) {
            if (event.target === el && event.animationName === name) {
              cleanUp();
              return "string" == typeof event.animationName &&
      ...
      function watchElementForClose(element, handler) {
        ...
        (sacrificialFrame = document.createElement("iframe")).setAttribute(
          "name",
        ...
        if (performance && "function" == typeof performance.getEntries) {
          ...
          for (var i = 0; i < entries.length; i++) {
            ...
            if (
              entry &&
              entry.name &&
              0 === entry.name.indexOf(url) &&
              "number" == typeof entry.duration
            )
      ...
      function insertShadowSlot(element) {
        ...
        return isShadowElement(shadowHost)
          ? insertShadowSlot(slotProvider)
          : slotProvider;
      }
      ...
      var getCurrentScriptUID = memoize(function () {
        ...
        if (script.src) {
          ...
          uid =
            "uid_" + hashedString.slice(hashedString.length - UID_HASH_LENGTH);
        } else uid = uniqueID();
      ...
      function submitForm(_ref3) {
        ...
        if (body)
          for (
            ...
            input.setAttribute(
              "value",
              null == (_body$key = body[key]) ? void 0 : _body$key.toString()
            );
      ...
      function experiment(_ref) {
        var name = _ref.name,
          ...
          logTreatment =
            void 0 === _ref$logTreatment ? src_util_noop : _ref$logTreatment,
          _ref$logCheckpoint = _ref.logCheckpoint,
          logCheckpoint =
            void 0 === _ref$logCheckpoint ? src_util_noop : _ref$logCheckpoint,
          _ref$sticky = _ref.sticky;
        var throttle =
          void 0 === _ref$sticky || _ref$sticky
            ? (function (name) {
        ...
        var treatment =
          ...
          (group =
            throttle < sample
              ? "test"
              : sample >= 50 || (sample <= throttle && throttle < 2 * sample)
              ? "control"
              : "throttle");
        var started = !1;
        var forced = !1;
        ...
        var exp = {
          ...
          log: function (checkpoint, payload) {
            ...
            isEventUnique(treatment + "_" + JSON.stringify(payload)) &&
              logTreatment({
                name: name,
                treatment: treatment,
                payload: payload,
      ...
      function request(_ref) {
        ...
        return new promise_ZalgoPromise(function (resolve, reject) {
          ...
          xhr.addEventListener(
            ...
            function () {
              var responseHeaders = (function (rawHeaders) {
                ...
                for (
                  var _i2 = 0,
                    _rawHeaders$trim$spli2 = rawHeaders.trim().split("\n");
              ...
              var isJSON =
                ...
                (0 === contentType.indexOf("application/json") ||
                  0 === contentType.indexOf("text/json"));
          ...
          for (var _key4 in normalizedHeaders)
            normalizedHeaders.hasOwnProperty(_key4) &&
        ...
        return new promise_ZalgoPromise(function (resolve, reject) {
          ...
          var avoid = function (name, fn) {
            ...
            return function () {
              ...
              promises.push({
                name: name,
                promise: promise_ZalgoPromise.asyncReject(
